...
const CREATE_ONE = 'insert into category(name, moduleid) values(${name}, ${moduleid}) returning id';
const ALL_BY_MODULECODE = `select c.* from
                           nakama.category c inner join module m on (c.moduleid = m.id)
